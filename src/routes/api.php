...
Route::prefix('v1/')->group(function (){
    ...
    Route::prefix('/channel')->group(function(){
        ...
        Route::get('/all', 'API\v1\Channel\ChannelController@getAllChannelsList')
            ->name('channel.all');

        Route::post('/create', 'API\v1\Channel\ChannelController@createNewChannel')
            ->name('channel.create');

        Route::put('/update', 'API\v1\Channel\ChannelController@updateChannel')
            ->name('channel.update');

        Route::delete('/delete', 'API\v1\Channel\ChannelController@deleteChannel')
            ->name('channel.delete');
    });
});
